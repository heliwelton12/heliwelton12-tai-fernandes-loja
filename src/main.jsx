...
if (isPrivacyRoute) {
  const privacyUrl = 'https://taifernandes-modaintima.netlify.app/privacidade'
  document.title = 'Política de Privacidade | Tai Fernandes Moda Íntima'
  ...
  setMeta('og:title', 'Política de Privacidade | Tai Fernandes Moda Íntima', 'property')
  setMeta(
    'og:description',
...
if (isStoreRoute) page = <App />
if (isAdminRoute) page = <AdminApp />
if (isPrivacyRoute) page = <PrivacyPage />
